...
| 3 | Notes | - The repository includes the **UBGG-3 m dataset** as coarse labels.<br>- Additional VFR images can be sourced via **Bing Maps**, **Google Earth**, or **ESRI World Imagery** APIs. |
